...
export const FIELD_CONSTRAINTS: Record<string, FieldConstraint> = {
  ...
  "DisciplineIn.ruleset": { "maxLength": 500 },
  ...
  "TournamentUpdate.city": { "maxLength": 120 },
  "TournamentUpdate.address": { "maxLength": 300 },
  ...
  "ManualEntryIn.name": { "minLength": 1, "maxLength": 200 },
  "ManualEntryIn.nationality": { "maxLength": 100 },
  "ManualEntryIn.club": { "maxLength": 200 },
  "ManualEntryIn.notes": { "maxLength": 2000 },
