...
def upgrade() -> None:
    ...
    with op.batch_alter_table("tournaments", schema=None) as batch_op:
        batch_op.alter_column("eur_rate", existing_type=sa.Numeric(12, 4), type_=sa.Numeric(12, 2))


def downgrade() -> None:
    with op.batch_alter_table("tournaments", schema=None) as batch_op:
        batch_op.alter_column("eur_rate", existing_type=sa.Numeric(12, 2), type_=sa.Numeric(12, 4))
