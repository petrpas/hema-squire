# tournament-modes Specification

## Purpose
Define the four independent features — schedule, payments, team disciplines and
extra services — that govern which of Squire's advanced surfaces a tournament's
console offers: how they are stored with the tournament, how easy and advanced
mode are named from them, how they are chosen at creation and changed on
`OTHER`, what turning one off hides and what it never writes, what each feature
governs, and how tournaments predating the features are derived from what they
use.
