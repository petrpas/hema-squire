# team-disciplines Specification

## Purpose
Define team disciplines: how a discipline is marked as individual or team, how a
team is entered and priced through its entrant's registration, how a roster of
named members is composed and edited without touching money, how the optional
composition deadline checks (but never enforces) roster completeness, and the
organizer's read-only view of teams.
