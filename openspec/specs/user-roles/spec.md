...
## Purpose
Define the global authorization model: the role ladder (Owner, Admin, Organizer, Fencer), how roles are granted and revoked, the Organizer plea workflow, and the admin panel surface.
